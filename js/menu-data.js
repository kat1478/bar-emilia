const menuData = [
  ...
  },
  {
    ...
    items: [
      { name: "Kawa parzona / rozpuszczalna", price: 8 },
      { name: "Espresso", price: 10 },
      { name: "Cappuccino", price: 10 },
      { name: "Latte macchiato", price: 10 },
      { name: "Herbata czarna", price: 5 },
      { name: "Herbata owocowa", price: 6 }
    ]
  },
  {
    category: "Surówki",
  ...
  },
  {
    ...
    items: [
      { name: "Frytki", price: 9 },
      { name: "Ziemniaki opiekane", price: 9 },
      { name: "Ziemniaki gotowane", price: 8 },
      { name: "Opakowanie na wynos", price: 1 },
      { name: "Dowóz na terenie Koszarówki i Grajewa", price: 8 }
    ]
  }
];
